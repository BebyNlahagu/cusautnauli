...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Ubah string format Rp 500.000 ke angka 500000
            function parseRupiah(rupiahStr) {
                return parseInt(rupiahStr.replace(/[Rp. ]/g, '')) || 0;
            }

            // Event input: saat user mengetik jumlah pinjaman
            $('#jumlah_pinjaman_display').on('input', function () {
                ...
                $('#jumlah_pinjaman').val(value); // untuk form
                $(this).val(formatRupiah(value)); // tampil ke user
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="number" name="bunga_pinjaman" class="form-control" id="bunga_pinjaman"
                                    ...
                                    value="{{ old('bunga_pinjaman', $n->bunga_pinjaman) }}" />
