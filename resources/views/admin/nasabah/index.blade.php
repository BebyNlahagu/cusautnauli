...
@section('content')
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                ...
                                                <form id="delete-form-{{ $n->id }}"
                                                    action="{{ route('nasabah.destroy', $n->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="number" class="form-control @error('Nik') is-invalid @enderror" id="Nik"
                                    name="Nik" placeholder="Nomor NIK" value="{{ old('Nik') }}" />
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="number" name="no_telp"
                                    ...
                                    placeholder="No. Hp/Wa" value="{{ old('no_telp') }}" />
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="date" name="tanggal_masuk"
                                    ...
                                    placeholder="No. Hp/Wa" value="{{ old('tanggal_masuk') }}" />
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="file" name="foto"
                                    ...
                                    placeholder="Jenis Usaha" value="{{ old('foto') }}" />
    ...
    {{-- Modal Edit  --}}
    @foreach ($nasabah as $n)
        <div class="modal fade" id="edit{{ $n->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="number" class="form-control @error('Nik') is-invalid @enderror"
                                    id="Nik" name="Nik" placeholder="Nomor NIK"
                                    value="{{ $n->Nik }}" />
                                <label for="floatingInput">Nomor NIK</label>
                                @error('Nik')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="number" name="no_telp"
                                    class="form-control @error('no_telp') is-invalid @enderror" id="No_telp"
                                    placeholder="No. Hp/Wa" value="{{ $n->no_telp }}" />
                                <label for="floatingInput">No. Hp/Wa</label>
                                @error('no_telp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="text" name="kelurahan"
                                    class="form-control @error('kelurahan') is-invalid @enderror" id="kelurahan"
                                    placeholder="Kelurahan" value="{{ $n->kelurahan }}" />
                                <label for="floatingInput">Kelurahan</label>
                                @error('kelurahan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                <input type="text" name="pekerjaan"
                                    class="form-control @error('pekerjaan') is-invalid @enderror" id="pekerjaan"
                                    placeholder="Jenis Usaha" value="{{ $n->pekerjaan }}" />
                                <label for="floatingInput">Pekerjaan</label>
                                @error('pekerjaan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                ...
                                <label for="floatingInput">Foto Diri</label>
                                <img id="fotoPreview"
                                    src="{{ old('foto', isset($n->foto) ? asset('images/' . $n->foto) : '#') }}"
                                    alt="Foto Preview"
                                    style="max-width: 200px; margin-top: 10px; display: {{ isset($n->foto) ? 'block' : 'none' }};" />
                                @error('foto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                ...
                                <label for="floatingInput">KTP</label>
                                <img id="ktpPreview"
                                    src="{{ old('ktp', isset($n->ktp) ? asset('images/' . $n->ktp) : '#') }}"
                                    alt="KTP Preview"
                                    style="max-width: 200px; margin-top: 10px; display: {{ isset($n->ktp) ? 'block' : 'none' }};" />
                                @error('ktp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-floating form-floating-custom mb-3">
                                ...
                                <label for="floatingInput">Kartu Keluarga</label>
                                <img id="kkPreview"
                                    src="{{ old('kk', isset($n->kk) ? asset('images/' . $n->kk) : '#') }}"
                                    alt="KK Preview"
                                    style="max-width: 200px; margin-top: 10px; display: {{ isset($n->kk) ? 'block' : 'none' }};" />
                                @error('kk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
