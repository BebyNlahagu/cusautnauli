                                                            ...
                                                            @else
                                                                <div class="alert alert-success p-3">
                                                                    ...
                                                                    <p><strong>Sisa Angsuran:</strong>
                                                                        <span
                                                                            class="badge bg-info">{{ number_format($detail->sisa_angsuran, 0, ',', '.') }}</span>
                                                                    </p>

                                                                    @if ($detail->denda > 0)
                                                                        <p><strong>Denda:</strong>
                                                                            <span
                                                                                class="badge bg-warning">{{ number_format($detail->denda, 0, ',', '.') }}</span>
                                                                        </p>
                                                                        <p><strong>Total Angsuran Setelah Denda:</strong>
                                                                            <span
                                                                                class="badge bg-success">{{ number_format($detail->total_angsuran, 0, ',', '.') }}</span>
                                                                        </p>
                                                                    @endif
                                                                </div>
                                                            @endif
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-end fw-bold">Rp
                                                        {{ number_format($totalPerUser[$nasabahId] ?? 0, 0, ',', '.') }}
                                                    </td>
                                                </tr>
                                            </tfoot>
                                            </tbody>
                ...
                if (nasabahId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#angsuran_bulan').val(formatCurrency(data
                                .angsuran_per_bulan_flat));
            ...
            fetch(`/angsuran/payment/${id}`)
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Token gagal!',
                        text: 'Tidak bisa membuat transaksi.',
                    });
                });
        }
