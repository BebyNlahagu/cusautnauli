                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-button-action">
                                        ...
                                        @else
                                            <span class="badge
                                                {{ $n->status === 'Disetujui' ? 'bg-success' : ($n->status === 'Ditolak' ? 'bg-danger' : 'bg-secondary') }}">
                                                {{ ucfirst($n->status) }}
                                            </span>
                                        @endif
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('pinjaman.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <div class="form-floating form-floating-custom mb-3">
                        <input type="text" class="form-control" id="nama_penjamin" name="nama_penjamin" placeholder="Penjamin" />
                        <label for="nama_penjamin">Penjamin</label>
                    </div>

                    <div class="form-floating form-floating-custom mb-3">
                        <input type="file" class="form-control" id="foto" name="foto" placeholder="Foto Penjamin" />
